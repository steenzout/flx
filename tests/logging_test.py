...
from flx.logging import DEFAULT_CONFIG_FILE


class LoadConfigurationTestCase(unittest.TestCase):
    """
    Tests for the flx.logging.load_configuration() function.
    """

    def setUp(self):
        # mock of logging.RootLogger
        self.patch_get_logger = mock.patch('flx.logging.logging.getLogger', autospec=True)
        self.mock_get_logger = self.patch_get_logger.start()

        self.patch_root_logger = mock.patch('flx.logging.logging.RootLogger', autospec=True)
        ...
        self.patch_fileConfig = mock.patch('flx.logging.config.fileConfig', autospec=True)
    ...
    def test_nofile(self):
        """
        Test flx.logging.load_configuration() when the configuration file doesn't exist.
        """
        self.mock_path.exists.return_value = True
    ...
    def test_errors(self):
        """
        Test flx.logging.load_configuration() when errors are raised.
        """
        self.mock_path.exists.return_value = True
        self.mock_path.isfile.return_value = True
